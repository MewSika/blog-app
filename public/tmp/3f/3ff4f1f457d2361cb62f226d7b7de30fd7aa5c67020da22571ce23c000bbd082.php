...
class __TwigTemplate_28fd15903fabff61511e7682b746488de1aca5826f751dd5c266c2db1d958c70 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card-body bg-light p-0\">
        ...
        <div class=\"card-text p-2\">
            ...
            <p class=\"small m-2\"> {{ post.getContent()[:100] }} <a href=\"{{ router.url('article', {'id': post.getId(), 'slug': post.getSlug()}) }}\" class=\"text-secondary fst-italic\">...lire la suite</a></p>
        </div>
    </div>
    <div class=\"card-footer bg-light text-end\">
