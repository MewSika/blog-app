...
class __TwigTemplate_3e38ff7f4b19b06d1bc8e72998d51046d836a3beb4e553ff336922933c34eae6 extends Template
{
    private $source;
    private $macros = [];
...
<form action=\"\" method=\"post\" class=\"mb-4\" enctype=\"multipart/form-data\">
    {% if post.getImage() %}
        ...
        <img src=\"{{ post.getImageURL('medium') }}\" alt=\"\" class=\"rounded shadow-sm mb-4\" loading=\"lazy\">
    {% endif %}
