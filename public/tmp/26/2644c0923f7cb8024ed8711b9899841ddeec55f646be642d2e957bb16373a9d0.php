...
/* fighters/_card.twig */
class __TwigTemplate_3cf71f102d4e7d34f04868c42bfd86b7b7f8926da5610b34ade5edc93fa9ed18 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["fighter"] ?? null), "getImage", [], "method", false, false, false, 9)) {
            ...
            echo "\" alt=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["fighter"] ?? null), "getName", [], "any", false, false, false, 11), "html", null, true);
            echo "\" loading=\"lazy\">
            </a>
            ";
        }
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["fighter"] ?? null), "getChamp", [], "any", false, false, false, 17) === 1)) {
            // line 18
            echo "                    <img src=\"/img/authors/ufc-belt-small.png\" alt=\"ufc belt\" loading=\"lazy\">
                ";
        }
        // line 20
    ...
    <div class=\"row\">
        ...
        <div class=\"col-12 col-md-3 height_crop text-center\">
            ...
            <a href=\"{{ router.url('fighter', {'id' : fighter.getID, 'name' : fighter.getName|replace({' ': '-'})|lower}) }}\">
                <img src=\"{{ fighter.getimageURL('medium') }}\" alt=\"{{ fighter.getName }}\" loading=\"lazy\">
            </a>
            {% endif %}
        </div>
        <div class=\"col-12 col-md-4 m-auto text-center\">
            <h4>
                {% if fighter.getChamp is same as 1 %}
                    <img src=\"/img/authors/ufc-belt-small.png\" alt=\"ufc belt\" loading=\"lazy\">
                {% endif %}
