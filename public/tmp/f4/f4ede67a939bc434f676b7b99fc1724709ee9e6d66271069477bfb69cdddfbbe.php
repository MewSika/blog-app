...
class __TwigTemplate_e4bb5ab8d269173b9c1af379d163d662fe5d5885bfd0496448c8e2a7a88ec945 extends Template
{
    private $source;
    private $macros = [];
    ...
    <ul class=\"nav flex-column\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["sideCategory"]) {
            ...
            // line 8
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["sideCategory"], "getName", [], "any", false, false, false, 8), "html", null, true);
            echo "</li>
        </a>
        ";
        }
...
<div class=\"card mb-3 shadow d-block d-sm-none\">
    ...
    <ul class=\"nav flex-column collapse\" id=\"categoryCollapse\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["sideCategory"]) {
            ...
            <li class=\"list-group-item list-group-item-action\">";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["sideCategory"], "getName", [], "any", false, false, false, 21), "html", null, true);
            echo "</li>
        </a>
        ";
        }
