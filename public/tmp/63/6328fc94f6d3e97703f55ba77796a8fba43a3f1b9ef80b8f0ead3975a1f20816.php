...
/* _navbar.twig */
class __TwigTemplate_bbd829fbde1525f638d96cbd62828f9129681409b7d834c7514e6f60deca3737 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_footeritem($__link__ = null, $__title__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 8
            echo "    <li>
        <a class=\"nav-link text-white p-0 d-inline-block\" href=";
            // line 9
            echo twig_escape_filter($this->env, ($context["link"] ?? null), "html", null, true);
            echo ">";
            echo twig_escape_filter($this->env, ($context["title"] ?? null), "html", null, true);
...
{% macro footeritem(link, title)%}
    <li>
        <a class=\"nav-link text-white p-0 d-inline-block\" href={{link}}>{{ title }}</a>
    </li>
{% endmacro %}
