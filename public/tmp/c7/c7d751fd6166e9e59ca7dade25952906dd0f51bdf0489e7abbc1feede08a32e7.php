...
class __TwigTemplate_fe8ef490a0ccc7f9fdd534dcedffc3678147afe70b8f0d03f2922f20b5110bcb extends Template
{
    private $source;
    private $macros = [];
...
<form action=\"\" method=\"post\" class=\"mb-4\" enctype=\"multipart/form-data\">
    {% if fighter.getImage() %}
        ...
        <img src=\"{{ fighter.getImageURL('medium') }}\" alt=\"\" class=\"rounded shadow-sm mb-4\">
    {% endif %}
